...
namespace RVL
{
    ...
    inline void EncodeVLE(int value, int*& pBuffer, int& word, int& nibblesWritten)
    {
    ...
    RVL_FORCEINLINE void EncodeVLE(int value, int*& pBuffer, int& word, int& nibblesWritten)
    {
        // Fast path: value fits in a single nibble (0-7)
